...
To my future self: I had to take a small detour from the announced program. Instead of the ASP.NET MVC 5 globalization hurdles post, I'll be taking notes on how to run a Rx timer subscription from a Python script running as a Windows service.
